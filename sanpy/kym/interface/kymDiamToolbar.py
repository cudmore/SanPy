...
class KymDiameterToolbar(QtWidgets.QGroupBox):
    ...
    def __init__(self, detectionDict : KymRoiDetection, groupName : str):
        super().__init__()
    ...
    def _buildUI(self):
        ...
        detectionGroupBox = QtWidgets.QGroupBox(self._groupName)
        ...
        self._addHLayout(aButton, vLayout, labelStr=None)
        ...
        self._addHLayout(aCheckBox, vLayout, labelStr=None)

        aName = 'line_width_diam'
        aSpinBox = self._aSpinBox(aName)
        self._detectionControls[aName] = aSpinBox
        self._addHLayout(aSpinBox, vLayout, labelStr=aName)

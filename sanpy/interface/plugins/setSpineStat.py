...
class SetSpineStat(sanpyPlugin):
    """Plugin to provide an interface to set spine stats like condition, userType, isBad, etc.
    ...
    def on_set_button(self):
        ...
        logger.info(f'  -->> emit eventDict:{eventDict}')
        self.signalSetSpikeStat.emit(eventDict)

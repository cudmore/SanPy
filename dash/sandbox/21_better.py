...
app.layout = html.Div(children=[
    ...
    html.Div(children=[
		...
		html.Button('Plot 1', id='g1-plot-button'),
	]),
	...
	html.Div(children=[
	    ...
	    html.Label('Most recent clickdata update-on-click-data'),
	    html.Pre(id='update-on-click-data', style=pre_style),
	
	    html.Label('my-Div'),
	    html.Pre(id='my-div', style=pre_style),
	]),
])
...
def my1(update_on_click_data, n_clicks):
	print('my1() update_on_click_data:', update_on_click_data, 'n_clicks:', n_clicks)
